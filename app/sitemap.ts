...
const pages = [
  ...
  { path: '/guides/expand-b2b-sales-to-czech-republic', priority: 0.95, changeFrequency: 'monthly' as const },
  { path: '/guides/czech-market-entry-for-b2b-companies', priority: 0.95, changeFrequency: 'monthly' as const },
  { path: '/guides/b2b-lead-generation-in-the-czech-republic', priority: 0.95, changeFrequency: 'monthly' as const },
